...
3. **어휘 (자연스러운 현대어 + 경건한 느낌)**:
   ...
   - **종결형 규칙 (경건하고 격식 있는 문체)**:
     * 기본: "~입니다", "~하십니다" 사용
     * 하나님/예수님의 직접 화법: 반말 종결("~것이다", "~한다", "~이다")로 번역하여 경건함과 권위를 표현
       - 예: "내가 주는 물을 마시는 사람은 영원히 목마르지 않을 것이다" (⭕)
       - 예: "내가 주는 물을 마시는 사람은 영원히 목마르지 않을 것입니다" (❌)
     * **구어체 종결형 절대 금지**: "~까", "~거야", "~네", "~지", "~어" 등 구어체 반말은 사용하지 말 것
       - 예: "하나님이 사랑하시는 거야" (❌) → "하나님이 사랑하신다" (⭕)
       - 예: "평안을 주실까" (❌) → "평안을 주실 것이다" (⭕)
       - 예: "내가 너를 사랑하니까" (❌) → "내가 너를 사랑하므로" 또는 "너를 향한 나의 사랑에서 비롯된 것이다" (⭕)
