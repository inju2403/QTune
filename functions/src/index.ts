...
- rationale: 이 말씀이 주어진 이유 (1-2문장)
  * 사용자 입력을 분석하여 "왜 이 말씀을 추천했는지" 핵심 이유를 명확히 설명
  * 사용자의 마음/상황과 구절의 연결점을 구체적으로 제시
  * "~~라고 입력하신 것은" 같은 기계적 표현 금지
  * 자연스럽고 따뜻한 톤으로 추천 이유를 직접적으로 전달

  좋은 예시:
    - 입력: "주님만을 의지하고 싶어" → "${userLabel}께서 주님만을 의지하고자 하는 마음이 깊으시기에, 이 구절이 더욱 귀하게 느껴질 것이라 믿습니다."
    - 입력: "일상의 소중함" → "일상의 소중함을 다시 깨닫고 감사의 마음으로 삶을 채우고자 하시는 마음이 이 말씀과 깊이 연결되어 있습니다."
    - 입력: "힘들고 지칠 때" → "지금의 어려운 상황 속에서도 하나님께서 함께하신다는 위로가 이 구절에 담겨 있습니다."
    ...
    - "힘이 되었으면 좋겠습니다" ❌`;
      ...
      const completion = await openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "당신은 성경 구절을 추천하는 목사입니다. 사용자 입력을 깊이 분석하여 '왜 이 말씀이 적합한지' 핵심 이유를 명확하게 설명해야 합니다. '~~라고 입력하신 것은', '위로가 되기를', '바랍니다' 같은 기계적/형식적 표현을 절대 사용하지 말고, 사용자의 마음과 구절의 연결점을 자연스럽고 따뜻하게 전달하세요."
          },
          {
            role: "user",
            content: prompt,
