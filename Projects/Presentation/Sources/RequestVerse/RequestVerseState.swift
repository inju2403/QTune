...
public struct GeneratedVerseResult: Equatable, Hashable {
    ...
    public let suggestedPrayer: String? // AI 추천 기도문 (옵셔널)
    ...
    public init(verseRef: String, verseText: String, verseTextEN: String?, korean: String, rationale: String, suggestedPrayer: String?, verse: Verse, secondaryVerse: Verse? = nil, isSafe: Bool) {
